    ...
    <div class="cart__item">
        <div class="lap__container">
            ...
            <div class="cart__item-img">
                <img class="lap__part-img" :src="require('../../assets/lap-card/' + cart_item_data.image)" alt="auto-part" />
            </div>
            <p class="lap__part-name">{{cart_item_data.name}}</p>
            <div class="cart__counter">
                <button class="cart__counter-decrement" @click="decrementItem">-</button>
                <p class="cart__counter-num">{{cart_item_data.quantity}}</p>
